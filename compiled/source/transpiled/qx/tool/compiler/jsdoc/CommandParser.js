(function () {
  ...
  qx.Class.define("qx.tool.compiler.jsdoc.CommandParser", {
    ...
    type: "abstract",
    members: {
      parseCommand: function parseCommand(pdoc, classname, analyser) {
        throw new Error("No implementation for " + this.classname + ".parseCommand");
      },
      resolveType: function resolveType(type, classname, analyser) {
        if (type) {
...
//# sourceMappingURL=CommandParser.js.map?dt=1649863178665