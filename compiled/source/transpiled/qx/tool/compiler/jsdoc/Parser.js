(function () {
  ...
  qx.Class.define("qx.tool.compiler.jsdoc.Parser", {
    ...
    statics: {
      ...
      parseJsDoc: function parseJsDoc(jsdoc, classname, analyser) {
        for (var key in jsdoc) {
          var parser = this.__PARSERS__P_184_0[key];

          if (parser) {
            jsdoc[key].forEach(function (pdoc) {
              return parser.parseCommand(pdoc, classname, analyser);
            });
          }
        }
      },
...
//# sourceMappingURL=Parser.js.map?dt=1649863178255