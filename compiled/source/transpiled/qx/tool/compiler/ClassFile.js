...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.ClassFile", {
    ...
    construct: function construct(analyser, className, library) {
      ...
      this.__analyser__P_180_0 = analyser;
      this.__className__P_180_1 = className;
      this.__metaStack__P_180_2 = [];
      this.__metaDefinitions__P_180_3 = {};
      this.__library__P_180_4 = library;
      this.__sourceFilename__P_180_5 = qx.tool.compiler.ClassFile.getSourcePath(library, className);
      this.__requiredClasses__P_180_6 = {};
      this.__environmentChecks__P_180_7 = {
        provided: {},
        required: {}
      };
      this.__requiredAssets__P_180_8 = [];
      this.__translations__P_180_9 = [];
      this.__markers__P_180_10 = [];
      this.__haveMarkersFor__P_180_11 = {};
      this.__scope__P_180_12 = {
        parent: null,
        vars: {},
        unresolved: {}
      };
      this.__externals__P_180_13 = [];
      this.__taskQueueDrains__P_180_14 = [];
      this.__taskQueue__P_180_15 = async.queue(function (task, cb) {
        task(cb);
      });
      this.__taskQueue__P_180_15.drain = this._onTaskQueueDrain;

      this.__taskQueue__P_180_15.error = function (err) {
      ...
      this.__globalSymbols__P_180_16 = {};
      this.__privates__P_180_17 = {};
      this.__blockedPrivates__P_180_18 = {};
      this.__privateMangling__P_180_19 = analyser.getManglePrivates();
      var CF = qx.tool.compiler.ClassFile;

      var addSymbols = function addSymbols(arr) {
        return arr.forEach(function (s) {
          return _this.__globalSymbols__P_180_16[s] = true;
        });
      };
    ...
    members: {
      __analyser__P_180_0: null,
      __className__P_180_1: null,
      __numClassesDefined__P_180_20: 0,
      __library__P_180_4: null,
      __requiredClasses__P_180_6: null,
      __environmentChecks__P_180_7: null,
      __requiredAssets__P_180_8: null,
      __translateMessageIds__P_180_21: null,
      __scope__P_180_12: null,
      __inDefer__P_180_22: false,
      __inConstruct__P_180_23: false,
      __taskQueue__P_180_15: null,
      __taskQueueDrains__P_180_14: null,
      __markers__P_180_10: null,
      __haveMarkersFor__P_180_11: null,
      __classMeta__P_180_24: null,
      __metaStack__P_180_2: null,
      __metaDefinitions__P_180_3: null,
      __fatalCompileError__P_180_25: false,
      __translations__P_180_9: null,
      __dbClassInfo__P_180_26: null,
      __hasDefer__P_180_27: null,
      __definingType__P_180_28: null,
      __sourceFilename__P_180_5: null,
      __taskQueueDrain__P_180_29: null,
      __globalSymbols__P_180_16: null,
      __privates__P_180_17: null,
      __blockedPrivates__P_180_18: null,
      __externals__P_180_13: null,
      _onTaskQueueDrain: function _onTaskQueueDrain() {
        var cbs = this.__taskQueueDrain__P_180_29;
        this.__taskQueueDrain__P_180_29 = [];
        cbs.forEach(function (cb) {
          cb();
        });
      },
      _waitForTaskQueueDrain: function _waitForTaskQueueDrain(cb) {
        if (this.__taskQueue__P_180_15.length() == 0) {
          cb();
        } else {
          this.__taskQueueDrains__P_180_14.push(cb);
        }
      },
      _queueTask: function _queueTask(cb) {
        this.__taskQueue__P_180_15.push(cb);
      },
      ...
      getSourcePath: function getSourcePath() {
        return this.__sourceFilename__P_180_5;
      },
      ...
      getOutputPath: function getOutputPath() {
        return qx.tool.compiler.ClassFile.getOutputPath(this.__analyser__P_180_0, this.__className__P_180_1);
      },
      ...
      load: function load(callback) {
        var t = this;
        var className = this.__className__P_180_1;
        t.__fatalCompileError__P_180_25 = false;
        t.__numClassesDefined__P_180_20 = 0;
        fs.readFile(this.getSourcePath(), {
          ...
          try {
            var babelConfig = t.__analyser__P_180_0.getBabelConfig() || {};
            ...
            if (this.__privateMangling__P_180_19 == "unreadable") {
            ...
            t.__fatalCompileError__P_180_25 = true;
          ...
          if (!t.__numClassesDefined__P_180_20) {
          ...
          if (!t.__metaDefinitions__P_180_3[className]) {
            t.addMarker("compiler.wrongClassName", null, className, Object.keys(t.__metaDefinitions__P_180_3).join(", "));
          ...
          qx.tool.utils.Utils.mkParentPath(outputPath, function (err) {
            ...
            if (qx.lang.Array.contains(t.__analyser__P_180_0.getApplicationTypes(), "browser")) {
      ...
      writeDbInfo: function writeDbInfo(dbClassInfo) {
        ...
        for (var key in this.__dbClassInfo__P_180_26) {
          dbClassInfo[key] = this.__dbClassInfo__P_180_26[key];
        }
      },
      ...
      _compileDbClassInfo: function _compileDbClassInfo() {
        var t = this;
        var dbClassInfo = this.__dbClassInfo__P_180_26 = {}; // Collect the dependencies on other classes

        var deps = this.getRequiredClasses();

        if (t.__usesJsx__P_180_30) {
        ...
        if (Object.keys(this.__environmentChecks__P_180_7.provided).length || Object.keys(this.__environmentChecks__P_180_7.required).length) {
          dbClassInfo.environment = {
            provided: [],
            required: {}
          };

          for (var key in this.__environmentChecks__P_180_7.provided) {
            dbClassInfo.environment.provided.push(key);
          }

          for (var _key in this.__environmentChecks__P_180_7.required) {
            dbClassInfo.environment.required[_key] = this.__environmentChecks__P_180_7.required[_key];
          }
        ...
        for (var _name in this.__scope__P_180_12.unresolved) {
          var item = this.__scope__P_180_12.unresolved[_name]; // item is undefined if it has already been removed from the list
          ...
          if (this.__metaDefinitions__P_180_3[_name]) {
            continue;
          }

          var info = t.__analyser__P_180_0.getSymbolType(_name);
        ...
        if (this.__externals__P_180_13.length) {
          dbClassInfo.externals = this.__externals__P_180_13;
        } // Translation


        if (this.__translations__P_180_9.length) {
          dbClassInfo.translations = this.__translations__P_180_9.slice(0);
        } // Markers


        if (this.__markers__P_180_10.length) {
          dbClassInfo.markers = qx.lang.Array.clone(this.__markers__P_180_10);
        } // Errors


        if (this.__fatalCompileError__P_180_25) {
      ...
      getOuterClassMeta: function getOuterClassMeta() {
        var src = this.__metaDefinitions__P_180_3[this.__className__P_180_1] || null;
      ...
      _babelClassPlugins: function _babelClassPlugins() {
        ...
        function enterFunction(path, node, idNode) {
          ...
          var isClassMember = t.__classMeta__P_180_24 && t.__classMeta__P_180_24._topLevel && t.__classMeta__P_180_24._topLevel.keyName == "members" && path.parentPath.parentPath.parentPath == t.__classMeta__P_180_24._topLevel.path;
        ...
        function makeMeta(sectionName, functionName, node) {
          ...
          if (functionName) {
            var section = t.__classMeta__P_180_24[sectionName];

            if (section === undefined) {
              section = t.__classMeta__P_180_24[sectionName] = {};
            }
            ...
            meta = t.__classMeta__P_180_24[sectionName];
        ...
        var COLLECT_CLASS_NAMES_VISITOR = {
          MemberExpression: function MemberExpression(path) {
            ...
            var info = t.__analyser__P_180_0.getSymbolType(str);
        ...
        var CODE_ELIMINATION_VISITOR = {
          ...
          CallExpression: function CallExpression(path) {
            ...
            if ((name === "qx.core.Environment.select" || name === "qx.core.Environment.get") && types.isLiteral(path.node.arguments[0])) {
              ...
              var env = t.__analyser__P_180_0.getEnvironment();
          ...
          IfStatement: {
            exit: function exit(path) {
              var node = path.node; // If it's a literal value, we can eliminate code because we can resolve it now.  This
        ...
        function collectJson(node, isProperties, jsonPath) {
          ...
          if (node.type == "ObjectExpression") {
            ...
            t.warn("Cannot interpret AST " + node.type + " at " + t.__className__P_180_1 + (node.loc ? " [" + node.loc.start.line + "," + node.loc.start.column + "]" : ""));
            result = null;
          }
        ...
        function isValidExtendClause(prop) {
          ...
          if (t.__classMeta__P_180_24.type === "class") {
            return false;
          }
        ...
        function checkValidTopLevel(path) {
          ...
          var allowedKeys = ALLOWED_KEYS[t.__classMeta__P_180_24.type];

          if (t.__classMeta__P_180_24.type === "class") {
            allowedKeys = allowedKeys[t.__classMeta__P_180_24.isStatic ? "static" : "normal"];
          }

          if (allowedKeys[keyName] === undefined) {
            t.addMarker("compiler.invalidClassDefinitionEntry", prop.loc, t.__classMeta__P_180_24.type, keyName);
          }
        }

        function handleTopLevelMethods(path, keyName, functionNode) {
          if (keyName == "defer") {
            t.__hasDefer__P_180_27 = true;
            t.__inDefer__P_180_22 = true;
          }

          t.__classMeta__P_180_24.functionName = FUNCTION_NAMES[keyName] || keyName;
          ...
          path.skip();
          t.__classMeta__P_180_24.functionName = null;
        }
          ...
          ObjectProperty: function ObjectProperty(path) {
            ...
            if (keyName == "extend") {
              if (!isValidExtendClause(prop)) {
                ...
                t.__classMeta__P_180_24.superClass = collapseMemberExpression(prop.value);

                t._requireClass(t.__classMeta__P_180_24.superClass, {
                  location: path.node.loc
                });
              }
            } else if (keyName == "type") {
              var type = prop.value.value;
              t.__classMeta__P_180_24.isAbstract = type === "abstract";
              t.__classMeta__P_180_24.isStatic = type === "static";
              t.__classMeta__P_180_24.isSingleton = type === "singleton";
            } else if (keyName == "implement") {
              path.skip();
              path.traverse(COLLECT_CLASS_NAMES_VISITOR, {
                collectedClasses: t.__classMeta__P_180_24.interfaces
              });
            } else if (keyName == "include") {
              path.skip();
              path.traverse(COLLECT_CLASS_NAMES_VISITOR, {
                collectedClasses: t.__classMeta__P_180_24.mixins
              });
            } else if (keyName == "members" || keyName == "statics" || keyName == "@") {
              t.__classMeta__P_180_24._topLevel = {
                path: path,
                keyName: keyName
              };
              path.skip();
              path.traverse(VISITOR);
              t.__classMeta__P_180_24._topLevel = null;
        ...
        var VISITOR = {
          NewExpression: {
            ...
            exit: function exit(path) {
              if (t.__analyser__P_180_0.isAddCreatedAt()) {
                var fn = types.memberExpression(types.identifier("qx"), types.identifier("$$createdAt"));
                var tmp = types.callExpression(fn, [path.node, types.stringLiteral(t.__className__P_180_1.replace(/\./g, "/") + ".js"), types.numericLiteral(path.node.loc ? path.node.loc.start.line : 0), types.numericLiteral(path.node.loc ? path.node.loc.start.column : 0)]);
          ...
          Program: {
            exit: function exit(path) {
              ...
              tmp = babylon.parse(t.__className__P_180_1 + ".$$dbClassInfo = $$dbClassInfo;").program.body;
              inject.push(tmp[0]);
          ...
          CallExpression: {
            enter: function enter(path) {
              ...
              function addTranslation(entry) {
                ...
                var cur = t.__translations__P_180_9[entry.msgid];
                ...
                if (cur) {
                  ...
                  t.__translations__P_180_9.push(entry);
                }
              }
              ...
              if (types.isMemberExpression(path.node.callee) || es6ClassDeclarations == 0 && (((_path$node$callee$obj = path.node.callee.object) === null || _path$node$callee$obj === void 0 ? void 0 : _path$node$callee$obj.type) == "Super" || path.node.callee.type == "Super")) {
                ...
                var name = collapseMemberExpression(path.node.callee);
                var thisAlias = null; // Try and translate aliases for "this"; this is a really simplistic implementation
                ...
                if (((_path$node$callee$obj2 = path.node.callee.object) === null || _path$node$callee$obj2 === void 0 ? void 0 : _path$node$callee$obj2.type) == "Identifier") {
                  ...
                  for (var scope = t.__scope__P_180_12; scope; scope = scope.parent) {
                    while (!aliasIsThis) {
                      var tmp = scope.vars[alias];
                ...
                if (TYPE[name]) {
                  t.__definingType__P_180_28 = name.match(/\.([a-zA-Z]+)\./)[1];
                  var node = path.node;
                  var className = node.arguments[0].value;
                  var classDef = node.arguments[1]; // We can only parse objects (eg qx.data.marshal.Json.__toClass creates objects on the fly that we cannot scan)
                  ...
                  t.__pushMeta__P_180_31(className);
                  ...
                  t.__classMeta__P_180_24.type = TYPE[name];

                  if (t.__definingType__P_180_28 == "Class" || t.__definingType__P_180_28 == "Bootstrap") {
                    var typeProp = classDef.properties.find(function (prop) {
                      return prop.key.type == "Identifier" && prop.key.value == "type";
                    });

                    if (typeProp) {
                      t.__classMeta__P_180_24.isStatic == typeProp.value.type == "Literal" && typeProp.value.value === "static";
                    }
                  }
                  ...
                  t.__popMeta__P_180_32(className);
                  ...
                  if (types.isLiteral(arg)) {
                    if (typeof arg.value != "string") {
                      ...
                      t.__environmentChecks__P_180_7.provided[arg.value] = true;

                      if (!arg.value.startsWith(t.__className__P_180_1) && !Object.prototype.hasOwnProperty.call(qx.tool.compiler.ClassFile.ENVIRONMENT_CONSTANTS, arg.value)) {
                        var symbol = t.__library__P_180_4.getSymbolType(arg.value);
                  ...
                  if (types.isLiteral(_arg)) {
                    if (typeof _arg.value != "string") {
                      log.error("Invalid argument to qx.core.Environment.get: " + _arg.value);
                    } else {
                      t.addEnvCheck(_arg.value, path.node.loc);
                    }
                  }
                  ...
                  if (types.isLiteral(_arg2)) {
                    if (typeof _arg2.value != "string") {
                      log.error("Invalid argument to qx.core.Environment.select: " + _arg2.value);
                    } else {
                  ...
                  var expr; // For mixins, there is never a valid time to call this.base() in the constructor; but it is
                  ...
                  if (t.__definingType__P_180_28 == "Mixin") {
                    expr = types.callExpression(expandMemberExpression("qx.Mixin.baseClassMethod"), [expandMemberExpression("this.constructor"), types.identifier(t.__classMeta__P_180_24.className), types.stringLiteral(t.__classMeta__P_180_24.functionName)]);
                    expr = types.memberExpression(expr, types.identifier("call"));
                  } else if (t.__classMeta__P_180_24.functionName == "$$constructor") {
                    expr = expandMemberExpression(t.__classMeta__P_180_24.superClass + ".constructor.call");
                  } else if (t.__classMeta__P_180_24.className) {
                    expr = expandMemberExpression(t.__classMeta__P_180_24.className + ".superclass" + ".prototype." + t.__classMeta__P_180_24.functionName + ".call");
                  } else {
                    expr = expandMemberExpression(t.__classMeta__P_180_24.superClass + ".prototype." + t.__classMeta__P_180_24.functionName + ".call");
                  }
                  ...
                  if (t.__definingType__P_180_28 == "Mixin") {
                    _expr = expandMemberExpression("this.constructor.superclass.prototype." + t.__classMeta__P_180_24.functionName + ".call");
                  } else if (t.__classMeta__P_180_24.functionName == "$$constructor") {
                    _expr = expandMemberExpression(t.__classMeta__P_180_24.superClass + ".constructor." + methodName);
                  } else {
                    _expr = expandMemberExpression(t.__className__P_180_1 + ".prototype." + t.__classMeta__P_180_24.functionName + ".base." + methodName);
                  ...
                  var _expr2 = expandMemberExpression(t.__classMeta__P_180_24.className);
                  ...
                  var _arg3 = getStringArg(0);

                  var arg1 = getStringArg(1);

                  if (!_arg3 || !arg1) {
                    t.addMarker("translate.invalidMessageIds", path.node.loc, _arg3, arg1);
                  } else {
                    addTranslation({
                      msgid: _arg3,
                      msgid_plural: arg1
                  ...
                  var _arg5 = getStringArg(1);

                  if (!_arg4 || !_arg5) {
                    t.addMarker("translate.invalidMessageIds", path.node.loc, _arg4, _arg5);
                  } else {
                    addTranslation({
                      msgid: _arg5,
                      comment: _arg4
                  ...
                  var _arg6 = getStringArg(0);

                  var _arg7 = getStringArg(1);

                  var arg2 = getStringArg(2);

                  if (!_arg6 || !_arg7 || !arg2) {
                    t.addMarker("translate.invalidMessageIds3", path.node.loc, _arg6, _arg7, arg2);
                  } else {
                    addTranslation({
                      msgid: _arg7,
                      msgid_plural: arg2,
                  ...
                  var pos = name.lastIndexOf("."); // name can be ".concat" when used with "[].concat"
          ...
          MemberExpression: {
            exit: function exit(path) {
              ...
              var members = name.split("."); // Ignore 'this' references
              ...
              if (t.__globalSymbols__P_180_16[members[0]] || t.hasDeclaration(members[0])) {
                return;
              }
          ...
          ObjectProperty: {
            exit: function exit(path) {
              if (this.__privateMangling__P_180_19 == "readable") {
          ...
          Property: function Property(path) {
            if (t.__classMeta__P_180_24 && t.__classMeta__P_180_24._topLevel && t.__classMeta__P_180_24._topLevel.path == path.parentPath.parentPath) {
              t.__classMeta__P_180_24.functionName = getKeyName(path.node.key);
              makeMeta(t.__classMeta__P_180_24._topLevel.keyName, t.__classMeta__P_180_24.functionName, path.node);
              path.skip();
              var functionId = null;
          ...
          ObjectMethod: function ObjectMethod(path) {
            ...
            if (t.__classMeta__P_180_24 && t.__classMeta__P_180_24._topLevel && t.__classMeta__P_180_24._topLevel.path == path.parentPath.parentPath) {
              ...
              path.traverse(VISITOR);
              exitFunction(path);
              t.__classMeta__P_180_24.functionName = null; // Otherwise traverse method as normal
            } else {
              path.skip();
              enterFunction(path);
              path.traverse(VISITOR);
            ...
            exit: function exit(path) {
              ...
              path.node.declarations.forEach(function (decl) {
                ...
                if (decl.id.type == "Identifier") {
                  var value = null; //decl.id.name = t.encodePrivate(decl.id.name, true, decl.loc);
       ...
       */
      __pushMeta__P_180_31: function __pushMeta__P_180_31(className) {
        var pos = (className || "").lastIndexOf(".");
        var meta = {
          className: className,
        ...
        this.__metaStack__P_180_2.push(meta);

        this.__classMeta__P_180_24 = meta;
        this.__metaDefinitions__P_180_3[className] = meta;
        this.__numClassesDefined__P_180_20++;
      },

      /**
       * Pops the current meta off the stack, optionally checking that the classname is correct
       */
      __popMeta__P_180_32: function __popMeta__P_180_32(className) {
        if (!this.__metaStack__P_180_2.length) {
          throw new Error("No __metaStack entries to pop");
        }

        var meta = this.__metaStack__P_180_2[this.__metaStack__P_180_2.length - 1];
        ...
        this.__metaStack__P_180_2.pop();

        meta = this.__metaStack__P_180_2[this.__metaStack__P_180_2.length - 1] || null;
        this.__classMeta__P_180_24 = meta;
      },
      ...
      popScope: function popScope(node) {
        var old = this.__scope__P_180_12;
        var scope = this.__scope__P_180_12 = this.__scope__P_180_12.parent;
      ...
      isLoadScope: function isLoadScope() {
        return !this.__scope__P_180_12.parent;
      },
      ...
      hasDefer: function hasDefer() {
        return this.__hasDefer__P_180_27;
      },
      ...
      addDeclaration: function addDeclaration(name, valueName) {
        if (this.__scope__P_180_12.vars[name] === undefined) {
          this.__scope__P_180_12.vars[name] = valueName || true;
          var unresolved = this.__scope__P_180_12.unresolved;
      ...
      hasDeclaration: function hasDeclaration(name) {
        ...
        for (var tmp = this.__scope__P_180_12; tmp; tmp = tmp.parent) {
      ...
      addReference: function addReference(name, loc) {
        ...
        var scope = this.__scope__P_180_12;
        ...
        if (name[0] === "this" || name[0] === "[]" || this.__globalSymbols__P_180_16[name[0]] || this.hasDeclaration(name[0])) {
          return;
        }
        ...
        for (var i = 0; i < name.length; i++) {
          ...
          if (this.__globalSymbols__P_180_16[str] || this.isIgnored(str)) {
            return;
          }
        }
        ...
        if (name == this.__className__P_180_1 || name.startsWith(this.__className__P_180_1 + ".") || name.startsWith("(")) {
          return;
        }
        ...
        if (!scope.unresolved[name]) {
          scope.unresolved[name] = {
            ...
            defer: this.__inDefer__P_180_22
          };
        } else if (loc) {
      ...
      encodePrivate: function encodePrivate(name, isIdentifier, location) {
        ...
        if (DO_NOT_ENCODE[name] || this.__privateMangling__P_180_19 == "off" || !name.startsWith("__") || !name.match(/^[0-9a-z_$]+$/i)) {
          return name;
        }
        ...
        var coded = this.__privates__P_180_17[name];
        ...
        if (!coded) {
          ...
          if (!isIdentifier) {
            this.__blockedPrivates__P_180_18[name] = true;
            return name;
          }

          if (this.__blockedPrivates__P_180_18[name]) {
            this.addMarker("class.blockedMangle", location, name);
            return name;
          }

          var db = this.__analyser__P_180_0.getDatabase();
          ...
          var prefix = prefixes.classPrefixes[this.__className__P_180_1];

          if (!prefix) {
            prefix = "__P_" + ++prefixes.nextPrefix + "_";
            prefixes.classPrefixes[this.__className__P_180_1] = prefix;
          }

          if (this.__privateMangling__P_180_19 == "readable") {
            coded = this.__privates__P_180_17[name] = name + prefix + Object.keys(this.__privates__P_180_17).length;
          } else {
            coded = this.__privates__P_180_17[name] = prefix + Object.keys(this.__privates__P_180_17).length;
          }
        }
      ...
      deleteReference: function deleteReference(name) {
        delete this.__scope__P_180_12.unresolved[name];
        var stub = name + ".";

        for (var id in this.__scope__P_180_12.unresolved) {
          if (id.startsWith(stub)) {
            delete this.__scope__P_180_12.unresolved[id];
          }
        }
      },
      ...
      addExternal: function addExternal(name) {
        if (this.__externals__P_180_13.indexOf(name) < 0) {
          this.__externals__P_180_13.push(name);
        }
      },
      ...
      addEnvCheck: function addEnvCheck(name, location) {
        ...
        var requiredOpts = {
          load: t.isLoadScope(),
          defer: t.__inDefer__P_180_22,
          construct: t.__classMeta__P_180_24 && t.__classMeta__P_180_24.functionName == "$$constructor",
          location: location
        };
        var dest = t.__environmentChecks__P_180_7.required[name];

        if (!dest) {
          dest = t.__environmentChecks__P_180_7.required[name] = {};
        }
        ...
        var info = t.__analyser__P_180_0.getSymbolType(name);
      ...
      addMarker: function addMarker(msgId, pos) {
        ...
        if (this.__haveMarkersFor__P_180_11[key]) {
          return;
        }

        this.__haveMarkersFor__P_180_11[key] = true;
        var marker = {
          msgId: msgId
        }; // Extract position
        ...
        this.__markers__P_180_10.push(marker);
      },
      ...
      _requireClass: function _requireClass(name, opts) {
        ...
        if (name == this.__className__P_180_1) {
          return null;
        }
        ...
        if (symbolType != "package" && className && className != t.__className__P_180_1) {
          // Re-check the class name as ignored if this is a member
          if (symbolType == "member" && t.isIgnored(className)) {
            return null;
          }

          var data = t.__requiredClasses__P_180_6[className];

          if (!data) {
            data = t.__requiredClasses__P_180_6[className] = {};
          }
          ...
          if (requireOpts.defer) {
            ...
            if (!name.startsWith(t.__className__P_180_1)) {
      ...
      _requireAsset: function _requireAsset(path) {
        ...
        if (!qx.lang.Array.contains(this.__requiredAssets__P_180_8, path)) {
          this.__requiredAssets__P_180_8.push(path);
        }
      },
      ...
      getAssets: function getAssets() {
        return this.__requiredAssets__P_180_8;
      },
       ...
       * @returns
       */
      __findProperty__P_180_33: function __findProperty__P_180_33(props, name) {
      ...
      getRequiredClasses: function getRequiredClasses() {
        return this.__requiredClasses__P_180_6;
      },
      ...
      getUnresolvedSymbols: function getUnresolvedSymbols() {
        return this.__scope__P_180_12.unresolved;
      },
      ...
      getClassName: function getClassName() {
        return this.__className__P_180_1;
      }
    },
    ...
    statics: {
       ...
       * @returns {String}
       */
      getSourcePath: function getSourcePath(library, className) {
       ...
       * @returns {String}
       */
      getOutputPath: function getOutputPath(analyser, className) {
...
//# sourceMappingURL=ClassFile.js.map?dt=1649863177889