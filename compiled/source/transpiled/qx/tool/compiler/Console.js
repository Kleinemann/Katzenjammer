(function () {
  ...
  qx.Class.define("qx.tool.compiler.Console", {
    ...
    statics: {
      __INSTANCE__P_182_0: null,

      /**
       * Returns the singleton instance
       */
      getInstance: function getInstance() {
        if (!this.__INSTANCE__P_182_0) {
          this.__INSTANCE__P_182_0 = new qx.tool.compiler.Console();
        }

        return this.__INSTANCE__P_182_0;
      },
...
//# sourceMappingURL=Console.js.map?dt=1649863178052