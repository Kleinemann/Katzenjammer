(function () {
  ...
  qx.Class.define("qx.tool.utils.json.Writer", {
    ...
    construct: function construct() {
      ...
      this.buffer = "";
      this.__indent__P_186_0 = 0;
      this.__indentStr__P_186_1 = "";
      this.__currentLine__P_186_2 = 0;
    },
    members: {
      /**
      ...
      write: function write(str) {
        ...
        while (true) {
          ...
          if (pos > -1) {
            ...
            this.__currentLine__P_186_2 = this.buffer.length;
            this.buffer += this.__indentStr__P_186_1;
            startPos = pos + 1;
          } else {
      ...
      indent: function indent(count) {
        if (this.__indent__P_186_0 + count < 0) {
          throw new Error("Unbalanced indent");
        }

        this.__indent__P_186_0 += count;
        var indentStr = this.__indentStr__P_186_1;
        ...
        var line = this.buffer.substring(this.__currentLine__P_186_2);

        if (!line.match(/[^\s]/)) {
          this.buffer = this.buffer.substring(0, this.__currentLine__P_186_2) + indentStr;
        }

        this.__indentStr__P_186_1 = indentStr;
        return this;
      },
      ...
      matchIndent: function matchIndent() {
        ...
        var m = line.match(/^([\s]*)/);
        var indent = m[0];
        var oldIndent = this.__indentStr__P_186_1;
        this.__indentStr__P_186_1 = indent;
        return oldIndent;
      },
...
//# sourceMappingURL=Writer.js.map?dt=1649863178774