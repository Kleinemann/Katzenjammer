(function () {
  ...
  *
  **/
  qx.Class.define("katzenjammer.data.ToolBox", {
    type: "static",
    statics: {
      createPassword: function createPassword(password) {
        return this.md5(this._md5Key + password + this._md5Key);
      },
       ...
       * 
       */
      _md5Key: "415d1aeb-acd8-4a4d-9071-4c0649772cdf",
      md5: function md5(str) {
        ...
        var utf8_encode = function utf8_encode(string) {
