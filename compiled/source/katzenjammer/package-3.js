  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.queue.Manager", {
    statics: {
       ...
       */
      __executeAndRescheduleOnError__P_36_5: qx.core.Environment.select("qx.debug", {
        ...
        "false": function _false(callback, finallyCode) {
          ...
          try {
            ...
            self.__scheduled__P_36_0 = false;
            self.__inFlush__P_36_4 = false;
            self.__retries__P_36_3 += 1;

            if (self.__retries__P_36_3 <= self.MAX_RETRIES) {
              self.scheduleFlush();
            } else {
              throw new Error("Fatal Error: Flush terminated " + (self.__retries__P_36_3 - 1) + " times in a row" + " due to exceptions in user code. The application has to be reloaded!");
            }
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Css", {
    statics: {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementHeight = qx.module.Css.__swap__P_172_0(elem, stylesToSwap, "_getHeight", this);
            } else {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementWidth = qx.module.Css.__swap__P_172_0(elem, stylesToSwap, "_getWidth", this);
            } else {
      ...
      _getContentHeight: function _getContentHeight(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentHeight = qx.module.Css.__swap__P_172_0(obj, stylesToSwap, "_getContentHeight", this);
          } else {
      ...
      _getContentWidth: function _getContentWidth(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentWidth = qx.module.Css.__swap__P_172_0(obj, stylesToSwap, "_getContentWidth", this);
          } else {
       ...
       * or <code>block</code>
       */
      __getDisplayDefault__P_172_2: function __getDisplayDefault__P_172_2(tagName, doc) {
        var defaults = qx.module.Css.__displayDefaults__P_172_1;
       ...
       */
      __swap__P_172_0: function __swap__P_172_0(element, styles, methodName, context) {
        ...
        this._forEachElementWrapped(function (item) {
          ...
          if (currentVal == "none") {
            if (prevVal && prevVal != "none") {
              ...
              newVal = qx.module.Css.__getDisplayDefault__P_172_2(item[0].tagName, doc);
            }
...
//# sourceMappingURL=package-3.js.map?dt=1652435555806
qx.$$packageData['3'] = {
  "locales": {},
  "resources": {},
  "translations": {}
